...
- Group members: Weichen Cai (GitHub: Peter20001208), Ning Xie (GitHub:2997804785/NingX), Cecilia Zhong (GitHub:zehanzhong)
...
The first two maps illustrate the spatial distribution of Divvy bike infrastructure and utilization across Chicago census tracts. **Grey areas indicate census tracts with no recorded Divvy bike activity or infrastructure in the dataset.** Bike dock capacity is heavily concentrated in downtown and North Side neighborhoods, while many tracts in the South and West Sides have substantially fewer bike stations or none at all. A similar spatial pattern appears in bike utilization, where trips per bike are highest in the same central areas. These patterns suggest that both infrastructure supply and usage are geographically clustered rather than evenly distributed. This finding relates directly to the research question by indicating that access to bike-share infrastructure may vary across neighborhoods.
